...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # conv
        X,cache1 = conv_forward_fast(X, W1, b1, conv_param)
        # relu
        X,cache2 = relu_forward(X)
        # max pooling
        X,cache3 = max_pool_forward_fast(X,pool_param)

        # affine
        X,cache4 = affine_forward(X,W2,b2)
        # relu
        X,cache5 = relu_forward(X)

        # affine
        scores,cache6 = affine_forward(X,W3,b3)
